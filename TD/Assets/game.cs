...
public class game : MonoBehaviour {
	...
	void Start () {
		...
		waves[3] = new int[] { 20, 12, 4, 8 };//4
		waves[4] = new int[] { 50, 12, 5, 10 }; //5
		waves[5] = new int[] { 20, 10, 7, 10 };//6
		waves[6] = new int[] { 20, 8, 8, 10 };//7
		...
		waves[25] = new int[] { 100, 10, 220, 10 };//26
		waves[26] = new int[] { 30, 4, 600, 20 };//27
		...
		waves[34] = new int[] { 350, 6, 370, 12 };//35
		waves[35] = new int[] { 100, 10, 390, 10 };//36
		waves[36] = new int[] { 100, 8, 410, 10 };//37
		waves[37] = new int[] { 100, 8, 440, 8 };//38
		waves[38] = new int[] { 150, 6, 460, 10 };//39
		waves[39] = new int[] { 400, 8, 500, 10 };//40
